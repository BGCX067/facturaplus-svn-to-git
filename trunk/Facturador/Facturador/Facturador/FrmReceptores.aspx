<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmReceptores.aspx.cs" Inherits="Facturador.FrmReceptores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <td width="70%" align="left"> 
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtRazonSocial" runat="server" ErrorMessage="RequiredFieldValidator"><br/>Proporcione una razón Social</asp:RequiredFieldValidator>
        </td>
    </tr>
       
     <tr>
    <td width="30%" align="right"> Tipo Emisor:</td>
    <td width="70%" align="left"> 
